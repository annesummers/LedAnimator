...
QMAKE    = /usr/bin/qmake
LedAnimator.pbproj/project.pbxproj: LedAnimator.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o LedAnimator.pbproj/project.pbxproj LedAnimator.pro
