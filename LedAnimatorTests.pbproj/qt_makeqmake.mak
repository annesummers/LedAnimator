...
QMAKE    = /usr/bin/qmake
LedAnimatorTests.pbproj/project.pbxproj: LedAnimator.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		...
		/usr/local/Qt4.8/mkspecs/features/qtestlib.prf \
	...
	$(QMAKE) CONFIG+=testing -o LedAnimatorTests.pbproj/project.pbxproj LedAnimator.pro
